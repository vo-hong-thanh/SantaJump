 ...
 * @author vot2
 */
public class RunSantaRun {

    public static void main(String[] args) throws Exception {
        System.out.println("Santa Jump");
        boolean dumpIt = true;
...
//            System.out.println(" >> read: " + data);
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter("SantaRun.csv"));
...
//                System.out.println(" location " + locations[i] +" = " + distances[i]);                    
            ...
            while (count < V) {
                ...
                for (int v = 0; v < V; v++) {
                    ...
                    if (distanceUV != 0 && mstSet[v] == false && distanceUV < distances[v]) {
                        parent[v] = u;
            ...
            while (i < fullPath.size()) {
                int locationIndex = fullPath.get(i);
            ...
            run++;
            long weightOfPath = 0;
            System.out.println("Starting at Location " + locations[fullPath.get(0)]);

            if (dumpIt) {
                dumpWriter.write("Starting at Location " + locations[fullPath.get(0)]);
                dumpWriter.newLine();
                dumpWriter.flush();
            }
            ...
            for (int r = 1; r < i; r++) {
                int locationIndex = fullPath.get(r);
                ...
                destinationList.remove(locations[fullPath.get(r)]);
    ...
    private static int minDistanceIndex(int V, double distances[], boolean mstSet[]) {
